...
| E10F | Scale approved controlled mutation benchmark from 8 to 24 cases | Implemented, pending CI/merge | Shadow only |
...
E0-E10F preserve source immutability and do not authorize production auto-correction. E11 is a separate authorization boundary. E12 may only provide optional evidence and may not bypass deterministic validation or host quality gates.
